...
For full API access request the following scopes: `account.liveUnits.manage`, `account.locations.manage`, `account.cameras.manage`
...
```shell
  curl --request POST \
   ...
   --data "grant_type=client_credentials&scope=account.liveUnits.manage,account.locations.manage,account.cameras.manage" \
